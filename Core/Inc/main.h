...
#define AP_ACTUAL_Pin GPIO_PIN_2
#define AP_ACTUAL_GPIO_Port GPIOA
#define AD_Pin GPIO_PIN_3
#define AD_GPIO_Port GPIOA
#define AP_ORIG_Pin GPIO_PIN_5
#define AP_ORIG_GPIO_Port GPIOA
...
#define YP_ORIG_Pin GPIO_PIN_5
#define YP_ORIG_GPIO_Port GPIOC
...
#define YP_ACTUAL_Pin GPIO_PIN_11
#define YP_ACTUAL_GPIO_Port GPIOB
