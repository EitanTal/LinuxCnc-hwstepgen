...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : AD_Pin ZP_Pin SPINDLE_PWM_Pin */
  GPIO_InitStruct.Pin = AD_Pin|ZP_Pin|SPINDLE_PWM_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pin : AP_Pin */
  GPIO_InitStruct.Pin = AP_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(AP_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : XD_Pin PB11 */
  GPIO_InitStruct.Pin = XD_Pin|GPIO_PIN_11;
  GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pin : OE1_Pin */
  GPIO_InitStruct.Pin = OE1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(OE1_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : JOY2_Pin */
  GPIO_InitStruct.Pin = JOY2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(JOY2_GPIO_Port, &GPIO_InitStruct);
