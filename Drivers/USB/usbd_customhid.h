...
#define CUSTOM_HID_EPIN_SIZE                         32U
...
#define CUSTOM_HID_EPOUT_SIZE                        32U
...
typedef struct _USBD_CUSTOM_HID_Itf
{
  ...
  int8_t (* Init)(void);
  int8_t (* DeInit)(void);
  int8_t (* OutEvent)(uint8_t* state); // ! Change the function prototype to get a buffer rather than 2 bytes
